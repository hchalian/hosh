      ...
      <section className="p-8">
        <article>
          ...
          <p>
            ...
            injured in automobile, pedestrian, motorcycle, and bicycle
            accidents, as well as slip and fall incidents, emotional distress
            cases, and other negligence-related situations. Our dedicated team
            is thoroughly equipped to handle every aspect of Personal Injury
            Claims, guiding you from the initial insurance claim to a jury trial
          ...
          <p>
            ...
            Medical Malpractice occurs when the medical service of any medical
            professional falls below the accepted standard of care for his or
            her field of medicine. Medical malpractice law is extremely complex
            and very expensive which is why most personal injury attorneys do
            not handle medical malpractice cases. In the last decade, Hosharian
            Law has successfully litigated a multitude of medical malpractice
            cases including malpractice in the areas of child-birth, botched
            surgeries, misdiagnosis or failure to diagnose, dangerous
            prescriptions, failure to prescribe, negligent supervision, wrongful
            death, and many more.
          </p>
          <p>
            If you believe you are a victim of Medical Malpractice, please
            contact Hosharian Law for a free consultation. We urge you to do
            this as soon as possible as there are usually impending deadlines to
            file lawsuits in these types of cases.
          </p>
        </article>
      </section>
    </main>
